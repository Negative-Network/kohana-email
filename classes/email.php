...
class Email {
	...
	protected static function _send_email($message, $max_tries = 1, $attempts = 0)
	{
		...
		{
			Kohana::$log->add(Log::ERROR, 'Sending email failed after '.$attempts.' attempts. Last error Message: '.$last_error);
			return 0;
		}
		...
		{
			Kohana::$log->add(Log::ERROR, 'Sending email failed after '.$attempts.' with unexpected exception: '.$e->getMessage());
			return 0;
		}
	}
